...
<body>
      ...
      <article style='opacity: 0.3'>
          ...
          <form action="checkout.jsp" method="POST" id="myForm">
              ...
              <input name="shippingAddress" type="text" value="<%=stName%>,<%=stAddr%>,店號:<%=stCode%>"> <!--shippingAddr必須與check_out.jsp中要帶入超商資料的欄位name一樣 -->
